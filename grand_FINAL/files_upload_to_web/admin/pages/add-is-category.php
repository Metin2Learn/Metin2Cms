...
if(isset($_POST["add_category"]))
{
    ...
    } elseif($is->categoryNameExists($name)) {
        $result = Core::result(Language::getTranslation("categoryAlreadyExists"), 2);
    } else {
        $is->addCategory($name, $_SESSION["username"]);
        ...
        <div class="col-md-12">
            <div class="grid">
                <div class="grid-body">
                    ...
                    ?>
                    <form method="POST" action="index.php?page=add-is-category" class="form-horizontal" role="form">
